...
$sendingAccountUsername    = 'inkandmetal5773@gmail.com';
$sendingAccountPassword    = 'francis5773';

// Recipient (To:) Details - Change this to the email details of who will receive all the emails from the website.
$recipientEmail            = 'inkandmetal5773@gmail.com';      // Where to send the admin email.
$recipientName             = 'Ink Metal'; // Name of admin to receive email from website.

// Email details - Change these to suit your website needs
$emailSubject              = 'Confirmation Email'; // Subject of the email that the admin will see.
$websiteName               = 'COVID-19 Robotics Donation Website';       // This is used as the "From name".
